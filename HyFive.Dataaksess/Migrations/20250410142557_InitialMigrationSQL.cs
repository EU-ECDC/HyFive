        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDefaultIndicated = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HealthEnterprise", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HealthEnterprise_RegionalHealthAuthority_RegionalHealthAuth~",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HealthEnterpriseId = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Institution_HealthEnterprise_HealthEnterpriseId",
                        column: x => x.HealthEnterpriseId,
                        principalTable: "HealthEnterprise",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "FourIndicationsObservation",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    FourIndicationsSessionId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FourIndicationsObservation", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FourIndicationsObservation_Activity_ActivityId",
                        column: x => x.ActivityId,
                        principalTable: "Activity",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_FourIndicationsObservation_Role_RoleId",
                        column: x => x.RoleId,
                        principalTable: "Role",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_FourIndicationsObservation_Session_FourIndicationsSessionId",
                        column: x => x.FourIndicationsSessionId,
                        principalTable: "Session",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FourIndicationsObservationIndicationType_FourIndicationsOb~",
                        column: x => x.ObservationsId,
                        principalTable: "FourIndicationsObservation",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FourIndicationsObservationIndicationType_IndicationType_In~",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FourIndicationsObservation_ActivityId",
                table: "FourIndicationsObservation",
                column: "ActivityId");

            migrationBuilder.CreateIndex(
                name: "IX_FourIndicationsObservation_FourIndicationsSessionId",
                table: "FourIndicationsObservation",
                column: "FourIndicationsSessionId");

            migrationBuilder.CreateIndex(
                name: "IX_FourIndicationsObservation_CreatedTime",
                table: "FourIndicationsObservation",
                column: "CreatedTime");

            migrationBuilder.CreateIndex(
                name: "IX_FourIndicationsObservation_RegisteredTime",
                table: "FourIndicationsObservation",
                column: "RegisteredTime");

            migrationBuilder.CreateIndex(
                name: "IX_FourIndicationsObservation_RoleId",
                table: "FourIndicationsObservation",
                column: "RoleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HealthEnterprise_RegionalHealthAuthorityId",
                table: "HealthEnterprise",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Institution_HealthEnterpriseId",
                table: "Institution",
                column: "HealthEnterpriseId");
