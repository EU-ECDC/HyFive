...
@Component({
  selector: 'app-app-register-hand-jewelry',
  templateUrl: './register-bare-below-elbows.component.html'
})

export class RegisterBareBelowElbowsComponent implements OnInit, OnDestroy {
