...
namespace HyFive.Services.AutoMapperProfiler.V1
{
    public class DomainToModelsV1 : Profile
    {
        public DomainToModelsV1()
        {
            ...
            CreateMap<Domain.Session.TransmissionStatusType, TransferStatusType>(MemberList.None);
            ...
            CreateMap<FourIndicationsObservation, FourIndicationsObservationReport>(MemberList.None)
                ...
                .ForMember(dest => dest.HealthcareTrust, opt => opt.MapFrom(src => src.FourIndicationsSession.Department.Institution.HealthcareProvider.Name))
                .ForMember(dest => dest.RegionalHealthcareTrust, opt => opt.MapFrom(src => src.FourIndicationsSession.Department.Institution.HealthcareProvider.RegionaltHealthcareProvider.Name))
            ...
            CreateMap<GloveObservation, GloveObservationReport>()
                ...
                .ForMember(dest => dest.HealthcareTrust, opt => opt.MapFrom(src => src.GloveSession.Department.Institution.HealthcareProvider.Name))
                .ForMember(dest => dest.RegionalHealthcareTrust, opt => opt.MapFrom(src => src.GloveSession.Department.Institution.HealthcareProvider.RegionaltHealthcareProvider.Name))
            ...
            CreateMap<HandJewelryObservation, HandJewelryObservationReport>()
               ...
               .ForMember(dest => dest.HealthTrust, opt => opt.MapFrom(src => src.HandJewelrySession.Department.Institution.HealthcareProvider.Name))
               .ForMember(dest => dest.RegionalHealthTrust, opt => opt.MapFrom(src => src.HandJewelrySession.Department.Institution.HealthcareProvider.RegionaltHealthcareProvider.Name))
            ...
            CreateMap<HyFive.Domain.Observation.ProtectiveEquipment.ProtectiveEquipment, PPEObservationReport>()
                ...
                .ForMember(dest => dest.CreateSessionTime, opt => opt.MapFrom(src => src.ProtectiveEquipmentObservation.ProtectiveEquipmentSession.CreatedTime))
                ...
                .ForMember(dest => dest.HealthTrust, opt => opt.MapFrom(src => src.ProtectiveEquipmentObservation.ProtectiveEquipmentSession.Department.Institution.HealthcareProvider.Name))
                .ForMember(dest => dest.RegionalHealthTrust, opt => opt.MapFrom(src => src.ProtectiveEquipmentObservation.ProtectiveEquipmentSession.Department.Institution.HealthcareProvider.RegionaltHealthcareProvider.Name))
            ...
            CreateMap<Domain.Place.HealthcareProvider, Models.V1.Institution.HealthcareEnterprise>()
                .ForMember(dest => dest.RegionaltHealthcareEnterpriseId, opt => opt.MapFrom(src => src.RegionaltHealthcareProvider != null ? src.RegionaltHealthcareProvider.Id : 0));
