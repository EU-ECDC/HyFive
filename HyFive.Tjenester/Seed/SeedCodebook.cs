        ...
        public class Handler : IRequestHandler<Command, bool>
        {
            ...
            public List<ProtectiveEquipmentSettingType> CreateSeedForProtectiveEquipmentSettingTypes(List<ProtectiveEquipmentType> types)
            {
                ...
                foreach (var settingType in settingTypes)
                {
                    ...
                    {
                        settingType.PPEConfigurationTypes = GetProtectionEquipmentSettingTypeProtectionEquipmentTypes(settingType, types,
            ...
            private static List<PPEConfigurationType> GetProtectionEquipmentSettingTypeProtectionEquipmentTypes(ProtectiveEquipmentSettingType settingType,
