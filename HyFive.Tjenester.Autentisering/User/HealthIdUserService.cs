...
namespace HyFive.Services.Authentication.User
{
    public class HealthIdUserService : IUserService
    {
        ...
        {
            return b => ((!string.IsNullOrEmpty(hrpNumber) && b.HPRNumber == hrpNumber) || (!string.IsNullOrEmpty(b.IdentityPseudonym) &&  b.IdentityPseudonym == identPseudonym)) && b.IsDisabled == false;
        }
        ...
        private bool IsCoordinatorForHealthcareProvider(string hrpNumber, string identPseudonym, int healthcareProvider)
        {
