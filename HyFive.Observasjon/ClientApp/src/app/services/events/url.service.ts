...
export class UrlService {
  ...
  registrerNewParameter(newParameterName: string): void {
    if (this.registeredUrlParameters === undefined) {
      ...
      const errorMsg = 'UrlService.registrerNewParameter(): UrlParam with name "'
  ...
  private checkForDoubleUpdate(): void {
    ...
    const errorMsg = 'UrlService.checkForDoubleUpdate(): '
      ...
      + 'This may indicate that a double URL update has been introduced!\n'
