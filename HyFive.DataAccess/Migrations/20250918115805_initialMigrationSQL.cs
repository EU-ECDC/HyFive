        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FacilityTypeId = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Facility_HealthcareOrganization_HealthcareOrganizationId",
                        column: x => x.HealthcareOrganizationId,
                        principalTable: "HealthcareOrganization",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Facility_Municipality_MunicipalityId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PredefinedComment_Facility_FacilityId",
                        column: x => x.FacilityId,
                        principalTable: "Facility",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Facility_HealthcareOrganizationId",
                table: "Facility",
                column: "HealthcareOrganizationId");

            migrationBuilder.CreateIndex(
                name: "IX_Facility_HERId",
                table: "Facility",
                column: "HERId");

            migrationBuilder.CreateIndex(
                name: "IX_Facility_MunicipalityId",
                table: "Facility",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FacilityType_Code",
                table: "FacilityType",
                column: "Code",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_FacilityType_Name",
                table: "FacilityType",
                column: "Name");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PredefinedComment_FacilityId",
